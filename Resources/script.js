...
var Gorskith = function(vic){
    ...
    g.performCombat = function(){
        ...
        if(me.healing){
            me.health += 5;
            game.print("The outermost later of rock and sediment falls off of the Gorskiths frame, getting swept away \
            by the swirling water surrounding it. You look on in shock as most of the proof that it has been fighting at \
        ...
        if(me.powerUp === true){
            ...
            to try protect yourself as much as possible, but its impossible to block it all. The rocks cut through what little \
            ...
            switch(choice){
                ...
                case 3:
                    ...
                    chest");
                    game.print("You take 5 points of damage, and here something go '<i>crunch</i>'... You may \
                    want to look into that later. While you don't have much medical knowlage, you <i>do</i> know that \
                    ribs shouldn't make that noise.");
                    break;
            }
        }
        else if(choice < 5){
            game.print("The Gorskith lets out some strange gurggling sounds, and a a huge spray of water leeps up from \
            ...
            me.powerUp = true;
            game.print("The water around the Gorskith picks up pace, rappidly accelerating, and the rocks from the \
            path around your feet start to jitter about, getting caught up in the current...");
            game.print("You are not quite sure what is happening, but it is definately nothing that will be good \
            for your health");
        }
        let heal = getRandom(1, 5);
        if(heal === 5){
            game.addGap(1);
            game.print("Specks of rock seem to be falling of the Gorskith, as if it were sheding");
            me.healing = true;
        }
    }
...
woods... so thats something you guess",["riverEncounter1", "Glenbrook Outskirts"],["Along the river!", "Maybe back to town..."]);
